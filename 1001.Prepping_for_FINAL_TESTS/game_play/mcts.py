...
class MCTS:
    ...
    def expand(self,node):
        ...
        if node != self.root_node:
            ...
            if self.cfg.exploration_type == 'episodic' and self.ep.move_number > 0:
                ...
                neighbours = self.ep.model.close_state_classifer(torch.cat((projections, tensor_of_prev_visited_states),1)) #moveNum, 1
