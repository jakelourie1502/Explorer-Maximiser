...
def compute_BL(algo): 
        ...
        while algo.frame_count < algo.cfg.total_frames:
            ...
            if algo.training_flags.train_flag:
                ...
                if algo.training_step_counter % 2 == 0 and algo.cfg.exploration_type == 'episodic' and algo.thresholdhitter > 5:
                    ...
                    for k in range(algo.K):
                        ...
                        predictions =  algo.ExpMaxTrain.close_state_classifer(true_fake_catted_with_proj).reshape(-1)
                        lossK = -torch.mean(\
                        ...
                        if np.random.uniform(0,2) < 1 and k in [0,1]:
